...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  ...
  const cardContent = (
    <div className="bg-bg/90 backdrop-blur-sm rounded-2xl p-6 flex flex-col border border-primary/20 group-hover/card:border-primary/40 group-hover/card:-translate-y-1.5 transition-all duration-500 ease-out relative overflow-hidden h-full">
